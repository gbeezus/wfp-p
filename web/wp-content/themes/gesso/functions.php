...
if ( ! function_exists( 'gesso_theme_setup' ) ) :
	...
	function gesso_theme_setup() {
		...
		add_image_size( 'large', 700, 800, false ); // Large Thumbnail.
		add_image_size( 'medium', 250, 600, false ); // Medium Thumbnail.
		add_image_size( 'small', 120, 400, false ); // Small Thumbnail.
	}
